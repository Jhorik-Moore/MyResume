...
public class Skills {
    ...
    private static  String HOVERED_HYP_STYLE = "-fx-background-color: transparent; -fx-scale-x: 1.1; -fx-scale-y: 1.1; -fx-scale-z:1.1;-fx-text-fill: #19c6bd";
    ...
    @FXML
    private Hyperlink SQL;

    @FXML
    private Hyperlink Nodered;

    @FXML
    private Hyperlink Corezoid;

    @FXML
    private Hyperlink Hotmessage;
    ...
    void initialize() {
        ...
        SQL.setStyle(IDLE_BUTTON_STYLE);
        SQL.setOnMouseEntered(e -> SQL.setStyle(HOVERED_HYP_STYLE));
        SQL.setOnMouseExited(e -> SQL.setStyle(IDLE_BUTTON_STYLE));

        Nodered.setStyle(IDLE_BUTTON_STYLE);
        Nodered.setOnMouseEntered(e -> Nodered.setStyle(HOVERED_HYP_STYLE));
        Nodered.setOnMouseExited(e -> Nodered.setStyle(IDLE_BUTTON_STYLE));

        Corezoid.setStyle(IDLE_BUTTON_STYLE);
        Corezoid.setOnMouseEntered(e -> Corezoid.setStyle(HOVERED_HYP_STYLE));
        Corezoid.setOnMouseExited(e -> Corezoid.setStyle(IDLE_BUTTON_STYLE));

        Hotmessage.setStyle(IDLE_BUTTON_STYLE);
        Hotmessage.setOnMouseEntered(e -> Hotmessage.setStyle(HOVERED_HYP_STYLE));
        Hotmessage.setOnMouseExited(e -> Hotmessage.setStyle(IDLE_BUTTON_STYLE));

        SQL.setOnAction(actionEvent -> {
            SQL.getScene();//.getWindow().hide();

            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/sample/SQL_Hyperlink.fxml"));
        ...
        Nodered.setOnAction(actionEvent -> {
            Nodered.getScene();//.getWindow().hide();

            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/sample/Nodered_Hyperlink.fxml"));
        ...
        Corezoid.setOnAction(actionEvent -> {
            Corezoid.getScene();//.getWindow().hide();

            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/sample/Corezoid_Hyperlink.fxml"));
        ...
        Hotmessage.setOnAction(actionEvent -> {
            Hotmessage.getScene();//.getWindow().hide();

            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/sample/Hotmessage_Hyperlink.fxml"));
        ...
        CONTACTS.setOnAction(actionEvent -> {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/sample/Contacts.fxml"));
        ...
        LANGUAGES.setOnAction(actionEvent -> {
            FXMLLoader loaderSkills = new FXMLLoader();
            loaderSkills.setLocation(getClass().getResource("/sample/Languages.fxml"));
            ...
            stage.show();
            LANGUAGES.getScene().getWindow().hide();
