...
public class Education {
    ...
    @FXML
    private Hyperlink Bachelor;

    @FXML
    private Hyperlink Specialist;
    ...
    void initialize() {
        ...
        Bachelor.setStyle(IDLE_BUTTON_STYLE);
        Bachelor.setOnMouseEntered(e -> Bachelor.setStyle(HOVERED_HYP_STYLE));
        Bachelor.setOnMouseExited(e -> Bachelor.setStyle(IDLE_BUTTON_STYLE));

        Specialist.setStyle(IDLE_BUTTON_STYLE);
        Specialist.setOnMouseEntered(e -> Specialist.setStyle(HOVERED_HYP_STYLE));
        Specialist.setOnMouseExited(e -> Specialist.setStyle(IDLE_BUTTON_STYLE));
        ...
        Bachelor.setOnAction(actionEvent -> {
            Bachelor.getScene();//.getWindow().hide();

            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/sample/Bachelor_Hyperlink.fxml"));
        ...
        Specialist.setOnAction(actionEvent -> {
            Specialist.getScene();//.getWindow().hide();

            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/sample/Specialist_Hyperlink.fxml"));
